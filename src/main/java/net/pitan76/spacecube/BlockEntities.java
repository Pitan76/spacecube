...
import net.pitan76.spacecube.blockentity.WallBlockEntity;

import java.util.function.Supplier;

public class BlockEntities {
    public static RegistryEvent<BlockEntityType<?>> SPACE_CUBE_BLOCK_ENTITY;
    public static RegistryEvent<BlockEntityType<?>> WALL_BLOCK_ENTITY;
    ...
    public static void init() {
        ...
        WALL_BLOCK_ENTITY = register(SpaceCube.id("wall"), () -> create(WallBlockEntity::new, Blocks.WALL, Blocks.SOLID_WALL));
    }
