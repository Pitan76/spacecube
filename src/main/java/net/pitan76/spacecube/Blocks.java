...
public class Blocks {
    public static SpaceCubeBlock TINY_SPCAE_CUBE = new SpaceCubeBlock(new CompatibleBlockSettings(_id("tiny_space_cube")).strength(5.0F, 6.0F), 2);
    public static SpaceCubeBlock SMALL_SPCAE_CUBE = new SpaceCubeBlock(new CompatibleBlockSettings(_id("small_space_cube")).strength(5.0F, 6.0F), 3);
    public static SpaceCubeBlock NORMAL_SPCAE_CUBE = new SpaceCubeBlock(new CompatibleBlockSettings(_id("normal_space_cube")).strength(5.0F, 6.0F), 4);
    public static SpaceCubeBlock LARGE_SPCAE_CUBE = new SpaceCubeBlock(new CompatibleBlockSettings(_id("large_space_cube")).strength(5.0F, 6.0F), 5);
    public static SpaceCubeBlock GIANT_SPCAE_CUBE = new SpaceCubeBlock(new CompatibleBlockSettings(_id("giant_space_cube")).strength(5.0F, 6.0F), 6);
    public static SpaceCubeBlock MAXIMUM_SPCAE_CUBE = new SpaceCubeBlock(new CompatibleBlockSettings(_id("maximum_space_cube")).strength(5.0F, 6.0F), 7);
