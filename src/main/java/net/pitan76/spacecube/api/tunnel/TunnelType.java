...
public class TunnelType {
    ...
    public static TunnelType NONE = new TunnelType(SpaceCube.id("none"), 0x00FF00, 0x00FF00, 0x00FF00);
    public static TunnelType ENERGY = new TunnelType(SpaceCube.id("energy_tunnel"), 0x00FF00, 0x19C419, 0x00FF00);
    public static TunnelType FLUID = new TunnelType(SpaceCube.id("fluid_tunnel"), 0x00FF00, 0x19C4C4, 0x00FF00);
    public static TunnelType ITEM = new TunnelType(SpaceCube.id("item_tunnel"), 0x00FF00, 0xE1C400, 0x00FF00);
    public static TunnelType REDSTONE = new TunnelType(SpaceCube.id("redstone_tunnel"), 0x00FF00, 0xE11900, 0x00FF00);
